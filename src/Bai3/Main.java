        ...
        while (true) {
            ...
            switch (line) {
                case "1": {
                    ...
                    switch (type) {
                        case "a": {
                            manageCandidate.add(createCadidate(scanner, "a"));
                            break;

                        }
                        case "b": {
                            manageCandidate.add(createCadidate(scanner, "b"));
                            break;
                        }
                        case "c": {
                            manageCandidate.add(createCadidate(scanner, "c"));
                            break;
                        }
                        default:
                ...
                case "2": {
                    manageCandidate.showInfor();
                    break;
                }
                case "3": {
                    System.out.print("Enter ID: ");
                    String id = scanner.nextLine();
                    Candidate candidate = manageCandidate.searchById(id);
                    if (candidate == null) {
